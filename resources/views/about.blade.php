                ...
                <div class="program_panes" id="wiki">
                    <div class="program_desc">
                        <div style="text-align:center">
                            <h4 dir="ltr"><strong>MariaEgypt&nbsp;</strong></h4>
                            <h4 dir="ltr"><strong>Gateway to Africa and Middle East</strong></h4>
                            <p dir="ltr" style="text-align:left">&nbsp;</p>
                            <h4 dir="ltr" style="text-align:justify">Since 1955 MariaEgypt believed in connecting and helping our curious travelers to explore, know and connect with other cultures.&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify">&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify">We connect curious travelers who want to discover the globe, enjoy mother nature and create cross continents friendships with local agencies who are passionate about designing tailor made trips and showing travelers around the hidden gems of their homeland creating an unforgettable memories and moments.</h4>
                            <h4 dir="ltr" style="text-align:justify">&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify">We have been online since 1999, responding to drastic changes in the tourism market and believing in connection. We managed successful partnerships with top-notch expert local agencies, hotels, governmental organization, and other key partners to achieve sustainable tourism impact.&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify">&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify">We at MariaEgypt believe in innovation, growing, and consistency along with our partners to ensure the delivery of a safe, excellent, and flexible experience to our travelers throughout the booking process, journey and even after returning.</h4>
                            <h4 dir="ltr" style="text-align:justify">&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:justify"><strong>~Our aim is to develop successful partnerships and the best representation for both of our companies worldwide. I look forward to building a network covering the whole world.~</strong></h4>
                            <h4 dir="ltr" style="text-align:justify">&nbsp;</h4>
                            <h4 dir="ltr" style="text-align:right">&nbsp;</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-12 offset-md-3">
            ...
            <form id="bookform" method="post" action="/Egypt/reservation_forms/requests/mail/">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <!-- <div id="recaptcha" class="g-recaptcha" data-sitekey="6LegDoYUAAAAALe9PVEiSlLyX3RzYBzKmoKrxMEz" data-callback="SubmitRegistration" data-size="invisible">
                                <div class="grecaptcha-badge" data-style="bottomright" style="width: 256px; height: 60px; display: block; transition: right 0.3s ease 0s; position: fixed; bottom: 14px; right: -186px; box-shadow: gray 0px 0px 5px; border-radius: 2px; overflow: hidden;">
                                    <div class="grecaptcha-logo"><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LegDoYUAAAAALe9PVEiSlLyX3RzYBzKmoKrxMEz&amp;co=aHR0cHM6Ly93d3cubWVtcGhpc3RvdXJzLmNvbTo0NDM.&amp;hl=en&amp;v=Km9gKuG06He-isPsP6saG8cn&amp;size=invisible&amp;cb=u4l8tkfczefz" width="256" height="60" role="presentation" name="a-m8a0dxpgo8d0" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div>
