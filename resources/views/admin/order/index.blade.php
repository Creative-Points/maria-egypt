                                    ...
                                    <td>
                                        <div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ route('admin.order.edit', $order->id) }}" class="dropdown-item">Edit</a>
                                                @if ($order->status == 1)
                                                    <a href="{{ route('admin.order.unactive', $order->id) }}" class="dropdown-item">Unctive</a>
                                                @else
                                                    <a href="{{ route('admin.order.active', $order->id) }}" class="dropdown-item">Active</a>
                                                @endif
