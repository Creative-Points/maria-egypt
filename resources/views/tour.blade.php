...
@section('content')
    ...
    <div class="container">
        ...
        @endif
        @if (session('error'))
            <div class="alert alert-danger">{{ session('error') }}. <a href='{{ route('user.setting') }}'>Go To Setting</a>
            </div>
        @endif
        @if ($errors->any())
                                    ...
                                    <div class="modal-body">
                                        <div class="container">
                                            <ul class="photo-tab nav nav-pills justify-content-start" id="pillsTab"
                                                role="tablist">
                                                <li class="nav-item"><a class="nav-link p-3 active show"
                                                        id="hostPhotosTab" data-bs-toggle="tab"
                                                        data-bs-target="#hostPhotos" role="tab"
                        ...
                        @guest
                            ...
                            @else
                                ...
                                @auth
                                    @if(count($old) > 0)
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label>You can use the information you used on the last trip.</label><br>
                                                    <a href="{{ route('user.oldorder', $place->slug) }}" class="new_btn_book">Use old information</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group label-floating">
                                            <div class="row">
                                                <label class="col-7">
                                                    <b>No. of Adults</b><br>
                                                    <span style="font-weight: normal" class="small">( + 12 years
                                                        )</span>
                                                </label>
                                                <div class="col-5">
                                        ...
                                        <div class="form-group label-floating">
                                            <div class="row">
                                                <label class="col-7">
                                                    ...
                                                    <span style="font-weight: normal" class="small">( 0 to 2 years
                                                        )</span>
                                                </label>
                                                <div class="col-5">
                                                    <div class="input-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group label-floating">
                                            <input type="checkbox" name="save" id="save" value="save"> Save this info for
                                            use in other Tour
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" value="Submit" class="new_btn_book"
                                                id="Enquire-btn">
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993"
        ...
        data-cf-beacon='{"rayId":"779a0ce99a3b839d","token":"a383b74b961c437b9a4f634ad772c1b6","version":"2022.11.3","si":100}'
        crossorigin="anonymous"></script>
    </body>
    <script src="https://www.memphistours.com/cache_js/Com2021-all-jquery-combined-new.v1640264538.js"></script>
    <script src="/com2021/js/bootstrap.bundle.min.js"></script>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 'success') {
                            ...
                            $('a[data-program_id="' + link_data + '"] > i.whishstate').css({
                                "color": "red"
                            })
                        }
                    }
    ...
    <script>
        ...
        function updateAgeFieldsAll(a, b, c) {
            ...
            for (var e = 0; b > e; e++) {
                if (c == "infant") {
                    var f = $("#ageInputDiv").clone().removeAttr("id").addClass("hidden age-input-div").removeClass(
                        "form-group label-floating");
                    f.find(".div-1").html("<input id='" + c + e +
                        "' type='hidden' size='3' class='form-control' maxlength='2'  min='1' value='1.99' max='11.99' name='infants_age[" +
                        c + "_" + e + "]' />"), d.append(f.removeClass("hidden"))
                } else {
                    var f = $("#ageInputDiv").clone().removeAttr("id").addClass("col-md-6 age-input-div");
                    f.find(".div-0").html("<label for='" + c + e + "'>Age of Child " + (e + 1) + "</label>"), f.find(
                        ".div-1").html("<input id='" + c + e +
    ...
    <script type="text/javascript">
        ...
        function updateSiteRatesTop(current_currency, session_update) {
            ...
            if (session_update) {
                jQuery.ajax({
                    url: '/ajax/dashboard/update_currency_session/' + current_currency
                });
            }
        }
        ...
        jQuery(document).ready(function() {
            jQuery("ul.subnav_top").parent().append(
            ...
            jQuery("ul.topnav_top li .hover").mouseover(function() { //When trigger is clicked...
                ...
                jQuery(this).parent().find("ul.subnav_top").slideDown('fast')
                    .show(); //Drop down the subnav on click
                jQuery(this).parent().hover(function() {}, function() {
                    jQuery(this).parent().find("ul.subnav_top").slideUp(
